...
class ObjectHelper {
    ...
    /**
     * Obtem a diferen�a entre os arrays enviados a partir do atributo informado
     ...
     * @return array[] $arrayReturn Array com os objetos que estão em um e não contem no outro
     */
