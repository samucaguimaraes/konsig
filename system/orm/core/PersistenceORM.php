...
class PersistenceORM {
    ...
    public static function monetario($persistence, $value) {
        ...
        if (isset($persistence->NotNull)) {
            if (!ValidateORM::notNull($value)) {
                PersistenceORM::$erro[] = "Campo n�o pode ser nulo";
            }
        }
    ...
    /**
     * Faz a persistencia de campos do tipo cpf ou cnpj
     * @tutorial PersistenceORM::cpfOrCnpj($ObjPersistence, "###.###.###-## | ##.###.###/####-##");
     * @param type $persistence
     * @param type $value
     * @return array
     */
    public static function cpfOrCnpj($persistence, $value) {
        ...
        if (ValidateORM::notNull($value)) {
            ...
            if ($dadosInvalidos) {
                PersistenceORM::$erro[] = "Dados invalidos, informe um CPF ou um CNPJ";
            }
...
//            }
    ...
    /**
     * Faz a persistencia de campos do tipo numero sequencial
     * @tutorial PersistenceORM::data($ObjPersistence, "000001/2016");
     * @param type $persistence
     * @param type $value
     * @return type 
     */
    public static function numeroSequencial($persistence, $value) {
        ...
        if (ValidateORM::notNull($value)) {
            ...
            #valida data
            if (!ValidateORM::numeroSequencial($value)) {
                PersistenceORM::$erro[] = "Numero invalido!!!";
            }

            # formatar data
            $value = FormatORM::numeroSequencialToInverso($value);
