...
class ValidateORM {
    ...
    /**
     * Verifica se tamanho da string � maior do quer o definido
     * @param type $value
     * @param type $size
     * @return boolean 
     */
    ...
    /**
     * Verifica se tamanho da string � menor do quer o definido
     * @param type $value
     * @param type $size
     * @return boolean 
     */
    ...
    /**
     * Valida se numero sequencial é valido
     * Validate::data('dd/mm/yyyy')
     * @param type $data
     * @return boolean 
     */
    public static function numeroSequencial($numero) {

        # verificar se o numero sequencial estar no formato correto
        if (!preg_match("/^[0-9]{6}\/[0-9]{4}$/", $numero)) {
            return false;
        }
