...
class PgSqlPdoStrategy {
    ...
    /**
     * Realiza a opera��o de select no banco de dados
    ...
    /**
     * Lista uma collection de objetos sem formata��o
     * @param type $where
     * @param type $objectCollection
     * @return boolean
     */
    ...
    public function salvar($dados, $objectResult = null, array $exception = null) {
        ...
        if (is_array($dados)) {
            ...
            $result[0] = false;
            $result[1] = $dados;
            $result[2]['post'] = 'N�o pode ser salvo (Para salvar precisa passar um objeto ou um array)';
            return $result;
        }
        ...
        if (isset($dados[$id_colmap]) && $dados[$id_colmap] != "") { // existe id em $dados
            ...
            if (!$id_serial) { // id n�o � serial
                ...
                if ($tObject === '0') {
                    ...
                    $result[0] = false;
                    $result[1] = $dados;
                    $result[2]['error'] = "ID do objeto informado n�o existe na base de dados ( {$id_colmap} = '{$dados[$id_colmap]}' ).";
                    return $result;
                }
    ...
    /**
     * Executa query de delete de acordo as configura��es
     *  passadas ignorando o objeto instanciado, os dados s�o passado 
     *  no formato de array onde o indice � o nome do campo no banco de dados
    ...
    /**
     * Deletar uma cole��o de dados na base de dados
     * @param type $id
     * @return type
     */
     ...
     * @param type $array
     *  null : n�o carrega, false: carrega id, true carrega obj
     * @param type $objectCollection
     * @return boolean
     */
        ...
        foreach ($this->propAtributos as $atributo => $propriedades) {
            ...
            if ($selectLoad) {
                ...
                if ($colmap !== false) {
                    ...
                    # Se existe um colmap e ele � diferente de '' e null
                    if (isset($array[$colmap]) && $array[$colmap] !== '' && $array[$colmap] !== null) {
