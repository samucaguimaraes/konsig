 ...
 * @author igor
 */
class TMetroUIv3 extends Controller {
    ...
    public function init() {
        ...
        $this->HTML->setTitle(NAME_SIS . " - {$this->getController()}/{$this->getAction()}");
        ...
        /* feedback */
        $script = TFeedbackMetroUIv3Helper::displayFeedback();
        ;
    ...
    private function dadosUsuario() {
        ...
        $this->addDados('nomeUsuario', current($arrayNome) . ' ' . end($arrayNome));
        $this->addDados('idUsuario', $this->SECURITY->getUsuario()->getId());
        unset($arrayNome);
    }

    private function viewMetro($content) {
        $arrayNome = FormatHelper::quebrarNome($this->SECURITY->getUsuario()->getNome());
        $dados = array();
        ...
        $path = VIEWS . "core/" . TEMPLATE . '/start-screen.phtml';
    ...
    public function TPageMetro($nome) {
        $this->dadosUsuario();
        /* JS */
        $this->HTML->addJavaScript(PATH_JS_CORE_URL . TEMPLATE . "/TPageMetro.js");
        /* CSS */
        $this->HTML->addCss(PATH_CSS_CORE_URL . TEMPLATE . "/TPageMetro.css");
    ...
    public function TPageSecondary($nome) {
        ...
        /* JS */
        $this->HTML->addJavaScript(PATH_JS_CORE_URL . TEMPLATE . "/docs.js");
        ...
        $this->HTML->addCss(PATH_CSS_CORE_URL . TEMPLATE . "/docs.css");
    ...
    public function TPdf($nome, $orientation = null) {
        ...
        $gerarPdf->exportarPDF($html, $orientation);
    }
