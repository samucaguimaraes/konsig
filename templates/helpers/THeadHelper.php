...
class THeadHelper {
    ...
    /**
     * Verifia se meta j� existe se n�o existir adicionar a metatag
     * @param type $meta
     */
    ...
    public function addMetaTag($atributos) {
        $this->setMetaTag("<META {$atributos}>\n");
    }
    ...
    /**
     * Adiciona meta tag charset ao head 
     * @param type $charset
     */
    public function addMetaCharset($charset) {
        $this->setMetaTag("<META charset='{$charset}'>\n");
    }
     ...
     * @param type $content
     */
    public function addMetaViewport($content) {
        $this->setMetaTag("<meta name='viewport' content='{$content}'>\n");
    }
